package com.cielio.applicationcontentprovider.database
...
import com.cielio.applicationcontentprovider.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        if (mUriMatcher.match(uri) == NOTES_BY_ID){
            ...
            val lineAffect = db.delete(TABLE_NOTES,
                "$_ID =?",
    ...
    companion object{
        const val AUTHORITY = "com.cielio.applicationcontentprovider.provider"
